local Material = loadstring(game:HttpGet("https://raw.githubusercontent.com/bbroblox03-ctrl/LibraryGUI/refs/heads/main/LOSLib.lua"))()
    ...
    local windowTitle = "KYYYYYYY - Legends Of Speed"
