...
local keylink = "BINGOT.DOF" -- put your key link here
 
local nameofthescript = "KYY Key" --put your script name here. leave blank too leave blank ig
 
local whoisitmadeby = "MARKYY" -- put your name here
 
local thenoteofthekey = "BAWAL SA PANGIT" --note you add here. leave blank to not have a note.
...
KeySystem.BorderColor3 = Color3.fromRGB(200, 0, 0)
...
KeyTextbox.BackgroundColor3 = Color3.fromRGB(0, 200, 0)
...
KeyTextbox.TextColor3 = Color3.fromRGB(0, 200, 0)
...
TextButton.TextColor3 = Color3.fromRGB(200, 0, 200)
...
TextButton.MouseButton1Click:Connect(function()
	if KeyTextbox.Text == key then
		...
		task.wait(1)
		loadstring(game:HttpGet("https://raw.githubusercontent.com/Kyypie69/Muscle-Legends/refs/heads/main/50kgXMarkyy.lua",true))() -- insert script on this line
		ScreenGui:Destroy()
	else
...
scriptname.BackgroundColor3 = Color3.fromRGB(200, 0, 0)
...
scriptname.TextColor3 = Color3.fromRGB(0, 200, 0)
...
madeby.TextColor3 = Color3.fromRGB(0, 200, 0)
...
note.BackgroundColor3 = Color3.fromRGB(200, 0, 200)
