...
local thenoteofthekey = "PUTANG INA NIYO DOF, CTX, ONYX!" --note you add here. leave blank to not have a note.
...
KeySystem.BackgroundColor3 = Color3.fromRGB(150, 175, 200)
KeySystem.BorderColor3 = Color3.fromRGB(70, 10, 70)
...
KeyTextbox.TextColor3 = Color3.fromRGB(255, 25, 255)
